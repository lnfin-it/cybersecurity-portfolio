...
Splunk, Suricata IDS, FortiGate UTM logs, Windows Event Logs, Sysmon, MISP, FTK Imager, ExifTool, Scalpel, PECmd, JumpListExplorer, basic OSINT workflows.

## How to use this repo

Start with the Featured investigations section. Open the PDFs. Each report includes a short executive summary, evidence, IOCs, and recommended response actions.
